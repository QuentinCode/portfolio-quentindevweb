    ...
    <div className={"flex items-center justify-around  w-full h-auto col-span-full max-xl:flex-col"}>
      <h2 className="  text-3xl md:text-3xl text-left text-accent capitalize">
        ...
        <form onSubmit={handleSubmit} className="flex items-center  w-800 h-auto max-xl:my-6 max-md:flex-col ">
          ...
          <label className={` cursor-pointer w-auto border-2 hover:border-accent rounded border-solid px-2 mr-6 h-auto  text-left text-1xl max-md:px-2 max-md:mr-0 max-md:mt-4 max-md:text-2xl ${checkboxes.checkbox3 ? 'border-accent' : ''} `}>
            <input
              type="checkbox"
              name="checkbox3"
        ...
        <div className="">
          <span className='text-3xl md:text-4xl text-accent text-center capitalize '>{sum}€</span>
        </div>
      </div>
